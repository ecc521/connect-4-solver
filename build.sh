...
emcc -O3 -std=c++20 -msimd128 -DNDEBUG -fwasm-exceptions -DCACHE_BUCKET_SIZE=2 -o wasm-out/analyze.js native/analyze.cpp -s NO_EXIT_RUNTIME=1 -s EXPORTED_FUNCTIONS="$EXPORTS" -s EXPORTED_RUNTIME_METHODS='["FS", "UTF8ToString", "stringToNewUTF8", "getValue", "wasmMemory"]' -s INITIAL_MEMORY=200MB -s ALLOW_MEMORY_GROWTH -s WASM=1 -s MODULARIZE=1 -s EXPORT_ES6=1 -s EXPORT_NAME="createModule" -s STACK_SIZE=1048576
