...
EMSCRIPTEN_KEEPALIVE void* createBook(int w, int h, const char* path) {
    ...
    if (w == 4 && h == 8) return C4_4x8::GameSolver::Connect4::OpeningBookBase<4, 8>::load(p, w, h).release();
    ...
    if (w == 5 && h == 8) return C4_5x8::GameSolver::Connect4::OpeningBookBase<5, 8>::load(p, w, h).release();
    ...
    if (w == 6 && h == 8) return C4_6x8::GameSolver::Connect4::OpeningBookBase<6, 8>::load(p, w, h).release();
    ...
    if (w == 7 && h == 8) return C4_7x8::GameSolver::Connect4::OpeningBookBase<7, 8>::load(p, w, h).release();
    ...
    if (w == 9 && h == 8) return C4_9x8::GameSolver::Connect4::OpeningBookBase<9, 8>::load(p, w, h).release();
    ...
    if (w == 10 && h == 8) return C4_10x8::GameSolver::Connect4::OpeningBookBase<10, 8>::load(p, w, h).release();
    ...
    if (w == 11 && h == 8) return C4_11x8::GameSolver::Connect4::OpeningBookBase<11, 8>::load(p, w, h).release();
    ...
    if (w == 12 && h == 8) return C4_12x8::GameSolver::Connect4::OpeningBookBase<12, 8>::load(p, w, h).release();
...
EMSCRIPTEN_KEEPALIVE int32_t* analyzeExact(int w, int h, void* solver, const char* pos, bool weak, int threads, void* book_ptr) {
    ...
    if (w == 4 && h == 8) return runAnalysis<C4_4x8::GameSolver::Connect4::Solver, C4_4x8::GameSolver::Connect4::Position, 8, 6, C4_4x8::GameSolver::Connect4::OpeningBookBase<4, 8>>(*static_cast<C4_4x8::GameSolver::Connect4::Solver*>(solver), pos, weak, threads, book_ptr);
    ...
    if (w == 5 && h == 8) return runAnalysis<C4_5x8::GameSolver::Connect4::Solver, C4_5x8::GameSolver::Connect4::Position, 8, 6, C4_5x8::GameSolver::Connect4::OpeningBookBase<5, 8>>(*static_cast<C4_5x8::GameSolver::Connect4::Solver*>(solver), pos, weak, threads, book_ptr);
    ...
    if (w == 6 && h == 8) return runAnalysis<C4_6x8::GameSolver::Connect4::Solver, C4_6x8::GameSolver::Connect4::Position, 8, 6, C4_6x8::GameSolver::Connect4::OpeningBookBase<6, 8>>(*static_cast<C4_6x8::GameSolver::Connect4::Solver*>(solver), pos, weak, threads, book_ptr);
    ...
    if (w == 7 && h == 8) return runAnalysis<C4_7x8::GameSolver::Connect4::Solver, C4_7x8::GameSolver::Connect4::Position, 8, 6, C4_7x8::GameSolver::Connect4::OpeningBookBase<7, 8>>(*static_cast<C4_7x8::GameSolver::Connect4::Solver*>(solver), pos, weak, threads, book_ptr);
    ...
    if (w == 9 && h == 8) return runAnalysis<C4_9x8::GameSolver::Connect4::Solver, C4_9x8::GameSolver::Connect4::Position, 8, 6, C4_9x8::GameSolver::Connect4::OpeningBookBase<9, 8>>(*static_cast<C4_9x8::GameSolver::Connect4::Solver*>(solver), pos, weak, threads, book_ptr);
    ...
    if (w == 10 && h == 8) return runAnalysis<C4_10x8::GameSolver::Connect4::Solver, C4_10x8::GameSolver::Connect4::Position, 8, 6, C4_10x8::GameSolver::Connect4::OpeningBookBase<10, 8>>(*static_cast<C4_10x8::GameSolver::Connect4::Solver*>(solver), pos, weak, threads, book_ptr);
    ...
    if (w == 11 && h == 8) return runAnalysis<C4_11x8::GameSolver::Connect4::Solver, C4_11x8::GameSolver::Connect4::Position, 8, 6, C4_11x8::GameSolver::Connect4::OpeningBookBase<11, 8>>(*static_cast<C4_11x8::GameSolver::Connect4::Solver*>(solver), pos, weak, threads, book_ptr);
    ...
    if (w == 12 && h == 8) return runAnalysis<C4_12x8::GameSolver::Connect4::Solver, C4_12x8::GameSolver::Connect4::Position, 8, 6, C4_12x8::GameSolver::Connect4::OpeningBookBase<12, 8>>(*static_cast<C4_12x8::GameSolver::Connect4::Solver*>(solver), pos, weak, threads, book_ptr);
